...
// Generated by metaharness — the `crm-hotelero` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx crm-hotelero`
...
// "bin" + "files" fields in package.json), so `npx crm-hotelero` works the moment
...
const HARNESS_NAME = 'crm-hotelero';

/** `crm-hotelero init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `crm-hotelero doctor` — verify the install end-to-end (kernel + host resolve). */
